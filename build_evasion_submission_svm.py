"""
Train a TF-IDF + Linear SVM classifier for Task 2 (evasion) and write a submission file.
...
- Predict the 308-row test split in original order and write `prediction2`.
- Print zip command.
"""
